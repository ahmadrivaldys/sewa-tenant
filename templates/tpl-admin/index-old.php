...
<!-- General CSS Files -->
<link rel="stylesheet" href="<?php echo base_url('assets/plugins/bootstrap/bootstrap.min.css'); ?>" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
        ...
        <div class="main-content">
          <section class="section">
            ...
            <div class="section-body">
              <h2 class="section-title"><?php echo $transaction_list->transaction_number; ?></h2>
              <p class="section-lead"><?php echo $transaction_list->tenant_name; ?></p>
              <div class="card">
                <div class="card-header">
                  <h4><?php echo $transaction_list->user_fullname; ?></h4>
                </div>
                <div class="card-body">
